...
class CassandraClient:
    ...
    def insert_sample_as_dict(self, sample: RowAsDictType) -> None:
        sample_obj = Sample(
    ...
    def add_some_data(self) -> None:
        ...
        self.insert_sample_as_dict(sample)

 # todo dodać obsługe błedów, jak select nic nie zwraca WSZEDZIE
    ...
    def get_samples_to_update_model_as_list_of_dicts(self, id):
        if id is None:
...
if __name__ == '__main__':
    ...
    print(db.get_samples_to_update_model_as_list_of_dicts(id))
    print(type(db.get_samples_to_update_model_as_list_of_dicts(id)[0]))
    print(len(db.get_samples_to_update_model_as_list_of_dicts(id)))